 ...
 * - MarketPricePredictionInput - Input schema for the flow.
 * - MarketPricePredictionOutput - Output schema for the flow.
 */
...
1.  A predicted price range in Indian Rupees (₹) per quintal.
